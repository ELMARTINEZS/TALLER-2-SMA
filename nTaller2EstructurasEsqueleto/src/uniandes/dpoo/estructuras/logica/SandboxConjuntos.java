...
public class SandboxConjuntos
{
    ...
    {
    	List<String> listaCadenas = new ArrayList<>(this.arbolCadenas.descendingSet());
    ...
    {
    	List<String> listaCadenas = new ArrayList<>(this.arbolCadenas.tailSet(cadena));
    	return listaCadenas;
    }
    ...
    {
    	for(String i:this.arbolCadenas.descendingSet()) {
    		if(i.equalsIgnoreCase(cadena)) {
    			this.arbolCadenas.remove(i);
    		}
    	}
    }
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	for(Object i:objetos) {
    		this.arbolCadenas.add(i.toString());
    	}
    }
    ...
    {
        TreeSet <String> Arbol2 = new TreeSet<String>(this.arbolCadenas.descendingSet());
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        for(String i: otroArreglo) {
        	if (!this.arbolCadenas.contains(i)) {
        		return false;
        	}
        }
        return true;
