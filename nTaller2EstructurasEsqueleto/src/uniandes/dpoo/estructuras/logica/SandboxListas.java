...
public class SandboxListas
{
    ...
    {
    	List<String> copia = new ArrayList<>(this.listaCadenas);
        return copia;
    }
    ...
    {
    	this.listaEnteros.removeIf(i -> i==valor);
    }
    ...
    {
    	this.listaCadenas.removeIf(i -> i==cadena);
    }
    ...
    public void reiniciarArregloCadenas( List<Object> objetos )
    {
    	...
    	for(Object w:objetos) {
    		listaCadenas.add(w.toString());	
    	}
    }
    ...
    {
    	for (int i = 0 ; i < this.listaEnteros.size() ; i++) {
    		int value=this.listaEnteros.get(i);
    		if (value<0) {
    			this.listaEnteros.set(i, value*-1);
    		}
    	}
    }
    ...
    {
    	this.listaEnteros.sort((x,y)-> y.compareTo(x));
    }
    ...
    {
    	this.listaCadenas.sort((x,y)-> x.compareTo(y));
    }
    ...
    {
    	int contador = 0;
    	for (int elem:this.listaEnteros) {
    		if (elem==valor) {
    			contador++;
    		}
    	}
    ...
    {
    	int contador = 0;
    	for (String elem:this.listaCadenas) {
    ...
    {
    	ArrayList<Integer> nRepetidos = new ArrayList<>();
    	ArrayList<Integer> Repetidos = new ArrayList<>();
    	int contador=0;
    	
    	for(int i: this.listaEnteros) {
    		if (!nRepetidos.contains(i)) {
    			nRepetidos.add(i);
    		}
    		else if (!Repetidos.contains(i)) {
    			Repetidos.add(i);
    			contador++;
    		}
    	}
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	for (int i = 0; i < cantidad ; i++) {
    		this.listaEnteros.add((int)(Math.random()*rango)+minimo);
    	}
    }
