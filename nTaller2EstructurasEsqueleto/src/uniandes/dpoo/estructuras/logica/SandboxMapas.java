...
public class SandboxMapas
{
    ...
    public String getUltima( )
    {
        ...
        return this.mapaCadenas.values().stream().max(String::compareTo).get();
    }
    ...
    {
    	return (int) this.mapaCadenas.values().stream().distinct().count();
    }
    ...
    public void agregarCadena( String cadena )
    {
    	...
    	String inv = new StringBuilder(cadena).reverse().toString();
    ...
    public void reiniciarMapaCadenas( List<Object> objetos )
    {
    	...
    	for(Object w: objetos) {
    		this.mapaCadenas.put(w.toString(), w.toString());
    	}
    }
    ...
    public void volverMayusculas( )
    {
        ...
        {
            Map2.put(i.getKey().toUpperCase(), i.getValue());
